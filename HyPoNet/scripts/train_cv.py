...
def main() -> None:
    ...
    parser.add_argument(
        "--supervision", choices=("soft", "hard"), default="soft",
        help="Soft targets use Bernoulli KL; the hard-label comparator uses BCE.",
    )
    parser.add_argument("--patience", type=int, default=10)
    parser.add_argument("--dwt-level", "--wp-level", dest="dwt_level", type=int, default=3)
    ...
    for fold in args.folds:
        # Each supervision run begins this fold from the same initialization,
        # regardless of how many epochs earlier folds required.
